...
- **12 reportes de pruebas de velocidad** (1 Gbps – 10 Gbps) con gráficas TCP/UDP, latencia y jitter
- **Diagrama de topología de red** XG-PON
- **Tabla de perfiles QoS**
- **Script bash** de pruebas iperf3
